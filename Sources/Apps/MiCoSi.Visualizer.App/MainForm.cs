...
namespace MiCoSi
{
  public partial class MainForm : Form
  {
    ...
    private void PerformAction(GuiAction action, Object arg, bool pausePlayback)
    {
      ...
      { UserErrors.VersionConflict(ex.Required); }
      catch (CompilationConflictException ex)
      { UserErrors.CompilationConflict(ex.Required); }
    ...
    {
      if (_context != null &&
        VisualSettingsForm.CreateAndShow(MiCoSi.DxRender.StyleManager.GetKnownNames(),
