...
namespace MiCoSi
{
  internal class CaptureAction : IOnTickAction
  {
                         ...
                         IOnTickActionContext context)
    {
      ...
      _imageRenderContext = new MiCoSi.DxRender.DxRenderContext(new DxRender.DefaultStyleAspect(), _imageRttAspect);

      _videoRttAspect
        = new MiCoSi.DxRender.TextureRenderTargetAspect(devices, _context.VideoWidth, _context.VideoHeight);
      _videoRenderContext = new MiCoSi.DxRender.DxRenderContext(new DxRender.DefaultStyleAspect(), _videoRttAspect);
