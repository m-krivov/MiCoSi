...
SimParameter::BaseType<SimParameter::Int::Type, int> *SimParameter::Int::_ref = nullptr;
...
SimParameter::BaseType<SimParameter::Double::Type, double> *SimParameter::Double::_ref = nullptr;
